...
class Player(AbstractPlayer):
    ...
    def __init__(self, game_time):
        ...
        self.minimax = AlphaBeta(_construct_minimax_player_utility(_heuristic),
                                                              self.get_succ,
                                                              None,
                                                              _is_goal_state)
    ...
    def make_move(self, time_limit):
        ...
        """
        depth = 1
        time_remaining = self.game_time/2
        max_depth = 7
        total_turn_time = time.time()
        while True:
            start = time.time()
            ...
            if time_remaining - interval * self.branching_factor < 0 or depth>=max_depth:
                break
            depth = depth + 1
        ...
        total_turn_time = time.time() - total_turn_time
        self.game_time = self.game_time - total_turn_time
